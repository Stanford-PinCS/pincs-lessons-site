  ...
  return (
    <div className="p-8 space-y-12">
      ...
      <section className="space-y-4">
        ...
        <p className="text-gray-600 mb-4">Used for creating highlighted content blocks with titles</p>
        <Block color="blue" title="Example Block">
          <p>This is an example of the Block component. It creates a bordered section with a title.</p>
      ...
      <section className="space-y-4">
        ...
        <p className="text-gray-600 mb-4">Used for creating colored background boxes</p>
      ...
      <section className="space-y-4">
        ...
        <p>
          This is a sentence with <Emphasize>emphasized text</Emphasize> in the middle.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-gray-600 mb-4">Used for highlighting key terms in yellow</p>
        <p>
      ...
      <section className="space-y-4">
        ...
        <p className="text-gray-600 mb-4">Used for creating centered, full-width slides</p>
        <div className="border border-gray-200 h-96">
          <Slide>
            <div className="text-center">
              <h3 className="text-2xl mb-4">Example Slide Content</h3>
              <p>This content is centered both horizontally and vertically within the slide.</p>
            </div>
          </Slide>
        </div>
      </section>
